...
describe AboutController do
  ...
  let(:valid_attributes) { { "history" => "MyText" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # AboutController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all about as @about" do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved about as @about" do
        ...
        post :create, {:about => { "history" => "invalid value" }}, valid_session
        assigns(:about).should be_a_new(About)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested about" do
        about = About.create! valid_attributes
        # Assuming there are no other about in the database, this
        # specifies that the About created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        About.any_instance.should_receive(:update_attributes).with({ "history" => "MyText" })
        put :update, {:id => about.to_param, :about => { "history" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the about as @about" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        About.any_instance.stub(:save).and_return(false)
        put :update, {:id => about.to_param, :about => { "history" => "invalid value" }}, valid_session
        assigns(:about).should eq(about)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the about list" do
      about = About.create! valid_attributes
      delete :destroy, {:id => about.to_param}, valid_session
      response.should redirect_to(about_index_url)
    end
  end
